...
public class ObsResource1_8Test extends BaseDelegatingResourceTest<ObsResource1_8, Obs> {
	...
	public void setGroupMembers_shouldSetGroupMembers () throws Exception {
		...
		ArrayList<String> membersAfterUuidlist = new ArrayList<String>();
		...
		for (Obs memberAfter : groupMembersAfter) {
			membersAfterUuidlist.add(memberAfter.getUuid());
		}

		ObsResource1_8.setGroupMembers(groupMemberParent, membersAfterUuidlist);
